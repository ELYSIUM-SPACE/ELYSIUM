...
/datum/antagonist/renegade
	...
	restricted_jobs = list(/datum/job/sfp_agent, /datum/job/sfp_curator, /datum/job/director, /datum/job/secretary, /datum/job/chief_engineer, /datum/job/dev_head, /datum/job/cmo)
