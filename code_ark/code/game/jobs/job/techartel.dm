...
return "Вы - Глава Разработки. Ваша роль представляет собой руководство и управление местным Техноартелем.  
Координируйте работу Учёных в создании высокотехнологичных и креативных продуктов и задавайте общий вектор разработки.
Ищите новые возможности и ресурсы. Возможно, Шахтёры или ЭК обладают интересными артефактами и находками, которые вы можете приобрести или… добыть альтернативными способами.
В случае необходимости - попытайте удачи найти на станции энтузиастов, которые помогут вам в ваших легальных или не очень инициативах.
Организовывайте розничную торговлю в вашем магазине или договаривайтесь о крупных поставках с частными клиентами или другими организациями.
Ваши изобретения могут во многом помочь обитателям станции или навредить им. 
Удачи!"
