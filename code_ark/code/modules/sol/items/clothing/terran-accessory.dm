...
/obj/item/clothing/accessory/terran/rank/navy
	...
	icon = 'code_ark/icons/obj/clothing/sol/obj_accessories_terran.dmi'
	accessory_icons = list(slot_w_uniform_str = 'code_ark/icons/mob/onmob/sol/onmob_accessories_terran.dmi', slot_wear_suit_str = 'code_ark/icons/mob/onmob/sol/onmob_accessories_terran.dmi')
