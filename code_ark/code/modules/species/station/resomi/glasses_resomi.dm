/obj/item/clothing/glasses/sunglasses/lenses
	...
	item_icons = list(slot_glasses_str = 'code_ark/icons/mob/species/resomi/onmob_eyes_resomi.dmi')
	icon = 'code_ark/icons/obj/clothing/species/resomi/obj_eyes_resomi.dmi'
