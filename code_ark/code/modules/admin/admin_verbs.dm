...
//	/client/proc/check_antagonists,		//shows all antags,
	/client/proc/cmd_check_new_players,
//	/client/proc/deadchat				//toggles deadchat on/off,
	/client/proc/player_panel,//_new,	закомментил во время ребейза		//shows an interface for all players, with links to various panels,
	/client/proc/invisimin,				//allows our mob to go invisible/visible,
//	/datum/admins/proc/show_traitor_panel,	//interface which shows a mob's mind, -Removed due to rare practical use. Moved to debug verbs ~Errorage,
	/datum/admins/proc/show_game_mode,  //Configuration window for the current game mode.,
	/datum/admins/proc/force_mode_latespawn, //Force the mode to try a latespawn proc,
	...
	/client/proc/admin_ghost,			//allows us to ghost/reenter body at will,
	/client/proc/toggle_view_range,		//changes how far we can see,
//	/datum/admins/proc/view_txt_log,	//shows the server log (diary) for today,	закомментил во время ребейза
//	/datum/admins/proc/view_atk_log,	//shows the server combat-log, doesn't do anything presently,	закомментил во время ребейза
	/client/proc/cmd_admin_pm_context,	//right-click adminPM interface,
	/client/proc/cmd_admin_pm_panel,	//admin-pm list,
	/client/proc/cmd_admin_delete,		//delete an instance/object/mob/etc,
	/client/proc/cmd_admin_check_contents,	//displays the contents of an instance,
	/datum/admins/proc/access_news_network,	//allows access of newscasters,
//	/client/proc/giveruntimelog,		//allows us to give access to runtime logs to somebody,	закомментил во время ребейза
//	/client/proc/getserverlog,			//allows us to fetch server logs (diary) for other days,	закомментил во время ребейза
	/client/proc/jumptocoord,			//we ghost and jump to a coordinate,
	/client/proc/Getmob,				//teleports a mob to our location,
	/client/proc/Getkey,				//teleports a mob with a certain ckey to our location,
//	/client/proc/sendmob,				//sends a mob somewhere, -Removed due to it needing two sorting procs to work, which were executed every time an admin right-clicked. ~Errorage,
